    ...
    public function index()
    {
        try {
            ...
            if ($expensesResponse->successful() && $costsResponse->successful() && $paymentResponse->successful()) {
                ...
                // Filter out transactions with "Pending" or "Rejected" status
                ...
                foreach ($filteredPaymentData as $transaction) {
                ...
                $currentRevenue = isset($filteredPaymentData[0]['transactionAmount']) ? $filteredPaymentData[0]['transactionAmount'] : 0;
